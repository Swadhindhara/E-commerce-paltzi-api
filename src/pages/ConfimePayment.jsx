    ...
    <div>
      <div className="main px-4 py-6 bg-zinc-100">
        <div className="container mx-auto">
          <div className="confirm_payment rounded-xl p-6 pb-24 bg-white shadow-lg flex items-center">
            <div className="left lg:w-1/2 w-full flex items-start flex-col gap-2">
              <p className="text-4xl font-bold leading-16 font-[Unbounded]">
              ...
              <div className="content mt-6 w-2/4">
                ...
                <div className="boxes mt-4 w-full">
                  ...
                  <Button className={`w-1/2 mt-5 bg-blue-400 rounded-4xl h-[45px] cursor-pointer hover:bg-blue-500`}>Track Order</Button>
                </div>
              </div>
            </div>
            <div className="right lg:w-1/2 w-full flex items-center justify-center flex-col">
              ...
              <div className="box w-[94%] p-6  mt-[-10px] relative z-1 bg-[#F6F6F6]">
                <div className="top flex flex-col w-full gap-4 items-start">
                  ...
                  <div className="box w-full h-[4px] border-t-1 border-dotted relative border-zinc-400 flex items-center">
                    <div className="left w-[55px] h-[55px] rounded-full bg-white absolute left-[-55px]"></div>
                    <div className="right w-[55px] h-[55px] rounded-full bg-white absolute right-[-55px]"></div>
                  </div>
                </div>
                <div className="bottom min-h-[100px]  w-full flex flex-col items-start py-6 gap-8 border-b-1 border-zinc-300">
                  ...
                  {items.map((item) => (
                    <div className="item flex items-center gap-2 w-full">
                      <img
                        src={item.images[0]}
                        alt="product_image"
                        loading="lazy"
