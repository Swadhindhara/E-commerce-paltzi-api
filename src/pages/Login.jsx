              ...
              <div className="form px-4 lg:px-6 py-16 shadow-lg rounded-lg w-full lg:w-1/2 flex flex-col items-start">
                ...
                <div className="box flex flex-col gap-2 mt-6 w-full">
                  <div className="content flex items-center justify-between">
                    ...
                    <Link to={'/forget-password'} className="text-zinc-400 text-sm">Forget Password?</Link>
                  </div>
                  <Input type="text" placeholder="Enter your password" />
                </div>
                <Button onClick={handleLogin} className='flex items-center gap-2 cursor-pointer bg-blue-400 self-center mt-6'>Sign In <ArrowRight/></Button>
                <p className="text-zinc-400 self-center mt-6">I don&apos;t have an account ? <Link className="text-zinc-500" to={'/register'}>Sign Up</Link></p>
              </div>
            </div>
            <div className="right w-full lg:w-1/3 h-full lg:bg-blue-200 relative flex items-center justify-center">
              <img src={g1} alt="" className="lg:absolute lg:bottom-0 lg:left-[-140px] w-full block"/>
            </div>
          </div>
        </div>
      </div>
